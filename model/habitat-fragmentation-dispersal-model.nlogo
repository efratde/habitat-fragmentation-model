extensions [rnd profiler stats table array csv]
...
to write_tables
  ...
  set fine_tbl stats:newtable
    stats:set-names fine_tbl ["dispersal distance" "relatedness"]


  set large_tbl stats:newtable
    stats:set-names large_tbl ["dispersal distance" "relatedness"]
  ...
  if (ticks > 1) [
    ...
    if (plant_plots) [
      calc.sgs
    ask plants [
      stats:add htz_dispersal (list distance.travelled heterozygosity maternal.gen.relatedness rd_coef)]
ask links with [link-length < sgs.scale] [stats:add fine_tbl (list link.relatedness link-length)]
    ask links with [link-length > sgs.scale] [stats:add large_tbl (list link.relatedness link-length)]
  ]
  ]
...
to plots ;; plots
  ...
  let .data []
  let _htz_dispersal []
  (ifelse   (plot? = "All") [set _htz_dispersal htz_dispersal
      set _plants plants]
[let y 0
      (ifelse
  ...
  (plot? = "Positive") [set y 1])
      ...
      set _htz_dispersal stats:newtable-from-row-list filter [x -> last x = y] stats:get-data-as-list htz_dispersal
      stats:set-names _htz_dispersal stats:get-names htz_dispersal
  ...
  (foreach (list 0 sgs.scale) (list sgs.scale max-pxcor) (list "fine-scale" "large-scale") (list fine_tbl large_tbl) [[a b x y] ->
 ...
 set-current-plot x
  clear-plot
    ...
    ask links with [link-length > a and link-length < b] [plotxy link-length link.relatedness]

    if not (empty? stats:get-data-as-list y ) [
  set-current-plot-pen "mean"
  let .coefs stats:regress-all y
  foreach (range a b ((b - a) / 10))  [t -> plotxy t ((item 0 .coefs) + (item 1 .coefs) * t )]
set-current-plot "sgs coefs dynamics"
      set-current-plot-pen x
      plotxy ticks item 1 .coefs
  ]])
  ;;#########################################
  ;;#########################################
...
to-report coefs [x y ]
  ifelse (x = 0 or ticks < 2)
  [report "NA"]
    [report item y stats:regress-all x]
end

to-report quantiles [V0 Q]
  ifelse (htz_dispersal = 0 or ticks < 2)
  [report "NA"]
  [report stats:quantile htz_dispersal V0 Q]
end
...
"" ""
PENS
"large-scale" 1.0 0 -13345367 true "" ""
"fine-scale" 1.0 0 -2674135 true "" ""
...
60
data
output-print stats:print-data multi_year_data
NIL
1
T
OBSERVER
...
setup</setup>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="plot.every">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dispersal-relatedness">
      <value value="1"/>
    ...
    <enumeratedValueSet variable=".color">
      <value value="&quot;white&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="dist">
      <value value="3"/>
  ...
  <experiment name="experiment" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="true">
    ...
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>length remove-duplicates reduce sentence (list [rd_coef] of turtles) &lt; 2</exitCondition>
    <metric>counter plants.all</metric>
    <metric>counter plants.all.0</metric>
    <metric>counter plants.all.1</metric>
    <metric>counter plants.all.2</metric>
    <metric>counter plants.all.3</metric>
    <metric>counter plants.all.4</metric>
    <metric>counter plants.neg</metric>
    <metric>counter plants.neg.0</metric>
    <metric>counter plants.neg.1</metric>
    <metric>counter plants.neg.2</metric>
    <metric>counter plants.neg.3</metric>
    <metric>counter plants.neg.4</metric>
    <metric>counter plants.neu</metric>
    <metric>counter plants.neu.0</metric>
    <metric>counter plants.neu.1</metric>
    <metric>counter plants.neu.2</metric>
    <metric>counter plants.neu.3</metric>
    <metric>counter plants.neu.4</metric>
    <metric>counter plants.pos</metric>
    <metric>counter plants.pos.0</metric>
    <metric>counter plants.pos.1</metric>
    <metric>counter plants.pos.2</metric>
    <metric>counter plants.pos.3</metric>
    <metric>counter plants.pos.4</metric>
    <metric>disp plants.all</metric>
    <metric>disp plants.all.0</metric>
    <metric>disp plants.all.1</metric>
    <metric>disp plants.all.2</metric>
    <metric>disp plants.all.3</metric>
    <metric>disp plants.all.4</metric>
    <metric>disp plants.neg</metric>
    <metric>disp plants.neg.0</metric>
    <metric>disp plants.neg.1</metric>
    <metric>disp plants.neg.2</metric>
    <metric>disp plants.neg.3</metric>
    <metric>disp plants.neg.4</metric>
    <metric>disp plants.neu</metric>
    <metric>disp plants.neu.0</metric>
    <metric>disp plants.neu.1</metric>
    <metric>disp plants.neu.2</metric>
    <metric>disp plants.neu.3</metric>
    <metric>disp plants.neu.4</metric>
    <metric>disp plants.pos</metric>
    <metric>disp plants.pos.0</metric>
    <metric>disp plants.pos.1</metric>
    <metric>disp plants.pos.2</metric>
    <metric>disp plants.pos.3</metric>
    <metric>disp plants.pos.4</metric>
    <metric>htz plants.all</metric>
    <metric>htz plants.all.0</metric>
    <metric>htz plants.all.1</metric>
    <metric>htz plants.all.2</metric>
    <metric>htz plants.all.3</metric>
    <metric>htz plants.all.4</metric>
    <metric>htz plants.neg</metric>
    <metric>htz plants.neg.0</metric>
    <metric>htz plants.neg.1</metric>
    <metric>htz plants.neg.2</metric>
    <metric>htz plants.neg.3</metric>
    <metric>htz plants.neg.4</metric>
    <metric>htz plants.neu</metric>
    <metric>htz plants.neu.0</metric>
    <metric>htz plants.neu.1</metric>
    <metric>htz plants.neu.2</metric>
    <metric>htz plants.neu.3</metric>
    <metric>htz plants.neu.4</metric>
    <metric>htz plants.pos</metric>
    <metric>htz plants.pos.0</metric>
    <metric>htz plants.pos.1</metric>
    <metric>htz plants.pos.2</metric>
    <metric>htz plants.pos.3</metric>
    <metric>htz plants.pos.4</metric>
    <metric>item 0 multi.data.sgs plants.all</metric>
    <metric>item 1 multi.data.sgs plants.all</metric>
    <metric>item 0 multi.data.sgs plants.neg</metric>
    <metric>item 1 multi.data.sgs plants.neg</metric>
    <metric>item 0 multi.data.sgs plants.neu</metric>
    <metric>item 1 multi.data.sgs plants.neu</metric>
    <metric>item 0 multi.data.sgs plants.pos</metric>
    <metric>item 1 multi.data.sgs plants.pos</metric>
    <enumeratedValueSet variable="fragmentation">
      <value value="&quot;no&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="changing.landscape">
  ...
  <experiment name="table-trial" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <final>csv:to-file (word "\" behaviorspace-experiment-name "\" behaviorspace-run-number ".csv") out</final>
    <timeLimit steps="20"/>
    <exitCondition>length remove-duplicates reduce sentence (list [rd_coef] of turtles) &lt; 2</exitCondition>
    <enumeratedValueSet variable="fragmentation">
      <value value="&quot;no&quot;"/>
  ...
  <experiment name="single" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="500"/>
    <exitCondition>length remove-duplicates reduce sentence (list [rd_coef] of turtles) &lt; 2</exitCondition>
