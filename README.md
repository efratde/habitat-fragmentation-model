...
> **Portfolio demonstration — synthetic data.** The fragmented landscapes, plant populations, dispersal kernels, and genetic data in this agent-based model are entirely generated by the simulation itself — they represent no real place, population, organism, or measurement. This is a portfolio piece, not a real dataset.
